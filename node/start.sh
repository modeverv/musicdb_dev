#! /bin/bash
FOLEVER_BIN=/home/seijiro/sinatra/musicdb_dev/node/node_modules/forever/bin/forever
...
LOGFILE0=/home/seijiro/sinatra/musicdb_dev/tmp/log/node.log
LOGFILE1=/home/seijiro/sinatra/musicdb_dev/tmp/log/node.log
...
forever start -a -l $LOGFILE -o $LOGFILE0 -e $LOGFILE1 --pidfile $PID web.js
